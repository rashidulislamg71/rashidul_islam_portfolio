...
//     <section
//       id="contact"
//       className="relative overflow-hidden py-15 text-white"
//     >
...
//           <h2 data-aos="fade-up"
//           data-aos-anchor-placement="center-bottom" className="mt-5 text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1]">
//             Let’s Build <br />
...
//           data-aos-anchor-placement="center-bottom" className="mt-5 max-w-3xl">
...
//           RIGHT
//           {/* <div data-aos="zoom-out-up" className="lg:col-span-7">
//             <form
