...
//           }}
//         >
//           <div className="w-[100px] h-[2px] rotate-[-45deg] bg-linear-to-r from-transparent via-cyan-300/40 to-white/40 blur-[1px]" />
//         </motion.div>
//       ))}
...
const GalaxyBackground = () => {
  ...
  // 6 meteors with DIFFERENT start positions
  const meteors = useMemo(
    () =>
      Array.from({ length: 6 }, () => ({
        startTop: random(60, 110),   
        startLeft: random(-20, 120),  
        duration: random(4, 6),
        delay: random(0, 2),
      })),
    []
