  ...
  return (
    <section id="skills" className="relative  py-16 md:py-20 mt-5 text-white overflow-hidden">
      <div className="container relative z-10">
        ...
        {/* Cards */}
        <div data-aos="zoom-out" className="grid grid-cols-1 md:grid-cols-3 gap-8 group ">
          {skills.map((cat, i) => (
            <div
              key={i}
            ...
            >
              ...
              <span className="text-cyan-300 mb-4 text-xl group-hover:translate-x-2 group-hover:text-white duration-500 transition-all ">
                {cat.icon}
              </span>
        ...
        >
          <p className="text-gray-400 italic">
            ...
            <span className="text-white">
              {" "}
              Advanced Frontend, Backend, Performance Optimization & Modern Web
              Architectures.
            </span>
          </p>
